...
class AppColors {
  ...
  static final Color hintsColor = const Color(0xff8391A1);
  static final Color textFieldBackgroundColor = const Color(0xffF7F8F9);
  static final Color textFieldBorderColor = const Color(0xffE8ECF4);
